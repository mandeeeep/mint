...
<!--                <div id="main-slider" class="top-banner"></div>-->
                ...
                <div  id="nav">
                    <ul>
                        ...
                        <li id="current"><a href="/mint/contenzo">Newsletters</a></li>
...
<!--                        <li><a href="index.html">Support</a></li>-->
        ...
        <!-- content starts -->
        <div id="content-outer"><div id="content-wrapper" class="cw-shadow-2 container_16">
